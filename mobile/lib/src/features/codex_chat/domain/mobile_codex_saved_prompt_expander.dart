String expandMobileCodexSavedPrompt(String body, String rawArguments) {
  final arguments = _tokenizeMobileCodexArguments(rawArguments);
...
List<String> _tokenizeMobileCodexArguments(String input) {
