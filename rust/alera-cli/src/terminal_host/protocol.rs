...
/// `agentProfile.launch` accepts a stable client mutation id and durably
/// replays its result for the same authenticated caller and workspace.
pub const RUNTIME_HOST_AGENT_PROFILE_LAUNCH_IDEMPOTENCY_CAPABILITY: &str =
